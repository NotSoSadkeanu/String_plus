...
END_TEST
// 3 спецификатора d с отрицательными числами
...
// 3 спецификатора d с положительными числами
...
// минус флаг плюс точность и ширина
